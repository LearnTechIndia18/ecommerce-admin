...
class viewCurrency extends React.Component {
    ...
    render() {
        ...
        if (this.state.viewStatus) {
            return <Redirect to='/listCurrency' />
        }
        return (
            <div className="container-fluid" style={{ width: '60%' }}>
                <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white me-2" style={{ marginLeft: '10rem', marginTop: '3rem' }}><i class="mdi mdi-comment-plus-outline"></i></span>View Currency</h3>
                <div className="row">
                            ...
                            <div className="card-body">
                                <form className="forms-sample" id="editFaq">
                                    ...
                                    <button type="button" className="btn btn-submit btn-gradient-primary me-2" style={{
                                        ...
                                        color: 'white'
                                    }} onClick={this.back}>Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
