...
class editConfiguration extends React.Component {
    componentDidMount(){
        this.props.AC_LIST_CONFIGURATION_OPTION();
      }
  constructor(props) {
    super(props);
    this.state = {
  ...
  validateOption() {
    ...
    if (name) {
      if (name.length < 1) {
        this.setState({ nameErrorOption: false, nameCountErrorOption: true });
      } 
      else {
        this.setState({ nameErrorOption: false, nameCountErrorOption: false });
      }
    }
    else {
      this.setState({ nameErrorOption: true, nameCountErrorOption: false });
    }

    if (slug) {
      if (slug.length < 1) {
        this.setState({ slugOptionError: false, slugOptionCountError: true });
      } else {
        this.setState({ slugOptionError: false, slugOptionCountError: false });
      }
    } else {
      this.setState({ slugOptionError: true, slugOptionCountError: false });
    }

    if (status) {
      this.setState({ statusErrorOption: false });
    } else {
      this.setState({ statusErrorOption: true });
    }
                  ...
                  <div class="card-body">
                    ...
                    <div className="row ">
                      <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" id="name" onChange={this.handleInputChangeOption} placeholder="Name"/>
                      </div>
                      <div class="form-group col-md-2">
                        <label for="exampleInputName1">Description</label>
                        <input type="text" class="form-control" id="description" onChange={this.handleInputChangeOption} placeholder="Description"/>
                      </div>
                      <div class="form-group col-md-2">
                        <label for="exampleInputName1">Slug</label>
                        <input type="text" class="form-control" id="slug" onChange={this.handleInputChangeOption} placeholder="Slug"/>
                      </div>
                      <div class="form-group col-md-2">
                        <label for="exampleInputName1">Sort</label>
                        <input type="text" class="form-control" id="sort" onChange={this.handleInputChangeOption} placeholder="Sort"/>
                      </div>
                      <div class="form-group col-md-2" >
                        <label for="inputState">Status</label>
                            <select id="status" class="form-control" style={{height:"2.8rem"}}>
                      ...
                      <button type="button" class="btn btn-gradient-success btn-rounded btn-fw" style={{
                        ...
                        position:'relative',
                        top:'1.4rem'
                      }} onClick={this.validateOption}>Add </button>
                      </div>
