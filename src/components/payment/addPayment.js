              ...
              <form class="forms-sample">
                ...
                <div class="form-group">
                  <label>
                    Mode:</label>
                    <div>
                      <input onChange={this.handleInputChange} type="radio" value="Sandbox" id="mode" name="mode"/>Sandbox<br/>
                      <input style={{position:'relative',top:'1rem'}} onChange={this.handleInputChange} type="radio" value="Live" id="mode" name="mode"/><span style={{position:'relative',top:'1rem'}}> Live</span>
                    </div>
                </div>
                ...
                <button type="button" class="btn btn-submit btn-gradient-primary me-2" style={{ backgroundColor: 'blue', color: 'white', borderRadius: '2rem',position:'relative',top:'1rem' }} onClick={this.validation}>Submit</button>
                <button type="button" class="btn btn-cancel btn-gradient-primary me-2" style={{ backgroundColor: 'blue', color: 'white', borderRadius: '2rem',position:'relative',top:'1rem' }} onClick={this.back}>Cancel</button>
              </form>
            </div>
          </div>
        </div>
