    ...
    render() {
        ...
        return (
            <div className="container-fluid"  style={{ width: '60%' }}>
                <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white me-2" style={{ marginLeft: '10rem', marginTop: '3rem' }}><i class="mdi mdi-comment-plus-outline"></i></span>Edit Payment</h3>
                <div className="row">
                                ...
                                <form className="forms-sample" id="editFaq">
                                    ...
                                    <div class="form-group">
                                        <label>
                                            Mode:</label>
                                        <div>
                                            <input onChange={this.handleInputChange} checked={mode} type="radio" value="Sandbox" id="mode" name="mode" /> Sandbox<br/>
                                            <input style={{position:'relative',top:'1rem'}} onChange={this.handleInputChange} checked={mode} type="radio" value="Live" id="mode" name="mode" /><span style={{position:'relative',top:'1rem'}}> Live</span>
                                        </div>
                                    </div>
                                    <div className="form-group" style={{position:'relative',top:'1rem'}}>
