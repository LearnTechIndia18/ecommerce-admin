    ...
    render() {
        ...
        return (
            <div className="container-fluid" style={{ width: '60%' }}>
                <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white me-2" style={{ marginLeft: '10rem', marginTop: '3rem' }}><i class="mdi mdi-comment-plus-outline"></i></span>View Image</h3>
                <div className="row">
